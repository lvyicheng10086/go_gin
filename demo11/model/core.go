...
var dsn = "root:root@tcp(127.0.0.1:3306)/go_gin?charset=utf8mb4&parseTime=True&loc=Local"
...
func init() {
	...
	err = DB.AutoMigrate(&student.Student{}, &student.Courses{}, &student.StudentCourse{})
	if err != nil {
